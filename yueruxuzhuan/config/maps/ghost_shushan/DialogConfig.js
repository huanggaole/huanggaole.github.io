// 鬼界蜀山 - 对话配置
window.GameConfig.dialogs.ghost_shushan = {
    tianguihuang_guide: {
        name: "天鬼皇",
    ...
    jiang_qing: {
        ...
        dialogs: [
            {
                id: "greeting",
                text: "呜呼．．师弟．．是我．．是我害死你们的．．",
                options: [
                    { text: "这位前辈怎么还是这般疯癫模样？", action: "closeDialog", nextDialog: null }
                ]
            }
        ]
    },
    ...
    yue_rou_xia: {
        ...
        dialogs: [
            {
                id: "greeting",
                text: "一位神秘的女子，在安抚疯癫的姜清。",
                speaker: " ",
                options: [
                    { text: "你是？", action: "startStory", target: "chapter3" }
                ]
            }
        ]
    }
